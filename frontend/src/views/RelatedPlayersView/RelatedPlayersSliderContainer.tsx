...
class RelatedPlayersSliderContainer extends React.Component<IProps> {
    ...
    private renderRelatedPlayersView = () => {
        return this.state.relatedPlayers.map(player => <RelatedPlayerViewItem player={player}/>)
    }
    ...
    public render() {
        ...
        return (<div className={classes.container}>
            ...
            <ItemsCarousel items={this.renderRelatedPlayersView()}/>
        </div>);
    }
}
